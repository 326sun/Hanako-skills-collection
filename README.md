...
本仓库是 Hanako 生态的一部分，与以下项目协作：

- **[hanako-runtime-learner](https://github.com/326sun/hanako-runtime-learner)** — 运行时自学习插件，观察交互模式并动态优化 skill 触发
- **[hanako-ui-beautify](https://github.com/326sun/hanako-ui-beautify)** — 视觉美化插件

---

## 设计原则

- **触发条件明确** 每个 skill 的 `description` 包含触发关键词和场景描述
